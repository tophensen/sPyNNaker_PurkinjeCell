...
__version__ = None
exec(open("python_models7/_version.py").read())
assert __version__

# Build a list of all project modules, as well as supplementary files
main_package = "python_models7"
...
setup(
    ...
    version=__version__,
    description="Templates for the Extensions of Spinnaker implementation "
                "specific for PyNN7",
    url="https://github.com/SpiNNakerManchester/SpyNNaker7NewModelTemplate",
    packages=packages,
